...
public class MxMessageBoundaryEvent {
	...
	public static String messageBoundaryEvent(Element root,List mxCellList,Element mxCell){
		//获取父节点开始
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static String messageBoundaryEventBpmndi(Element root,List mxCellList,Element mxCell){
		String nodeID = mxCell.attributeValue("nodeID");
