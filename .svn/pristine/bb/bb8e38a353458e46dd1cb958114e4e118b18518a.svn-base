...
public class MxSignalBoundaryEvent {
	...
	public static String signalBoundaryEvent(Element root,List mxCellList,Element mxCell){
		//获取父节点开始
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static String signalBoundaryEventBpmndi(Element root,List mxCellList,Element mxCell){
		String nodeID = mxCell.attributeValue("nodeID");
