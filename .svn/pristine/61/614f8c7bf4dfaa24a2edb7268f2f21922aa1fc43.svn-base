...
<meta charset="UTF-8">  
<title>流程任务-会签</title>  
<script type="text/javascript" src="../view/pc/lc-view/lc-task/approval_expressdeliveryApply.js"></script> 
</head>  
<body>  
	<input type="hidden" value="${taskData.task.id }" id= "taskId">
	<input type="hidden" value="${taskData.task.name }" id= "taskName">
	<input type="hidden" value="${taskData.businessKey }" id= "expressdeliveryApplyId">
