...
<meta charset="UTF-8">  
<title>消息中心</title>  
	<script type="text/javascript" src="../view/pc/xt-view/xt-message/xt-message-send-list.js"></script>   
	...
	<script type="text/javascript" src="../view/pc/xt-view/xt-message/xt-message-to-user.js"></script>  
</head>  
<body>  
</body>  
</html> 