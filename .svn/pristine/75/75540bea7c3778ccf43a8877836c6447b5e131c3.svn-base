 ...
 *
 */
public class MxCompensationBoundaryEvent {
	/**
	 * 补偿边界
	 * @param root
	 * @param mxCellList
	...
	public static String compensationBoundaryEvent(Element root,List mxCellList,Element mxCell){
		//获取父节点开始
		String pid = mxCell.attributeValue("id");
		Element pMxCel = MxUtils.getElement(mxCellList, pid);
		//获取父节点结束
		String task_node = "";
		/////////////基本属性开始/////////////
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static String compensationBoundaryEventBpmndi(Element root,List mxCellList,Element mxCell){
		String nodeID = mxCell.attributeValue("nodeID");
