 ...
 *
 */
public class MxErrorBoundaryEvent {
	/**
	 * 错误边界
	 * @param root
	 * @param mxCellList
	...
	public static String errorBoundaryEvent(Element root,List mxCellList,Element mxCell){
		//获取父节点开始
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static String errorBoundaryEventBpmndi(Element root,List mxCellList,Element mxCell){
		String nodeID = mxCell.attributeValue("nodeID");
