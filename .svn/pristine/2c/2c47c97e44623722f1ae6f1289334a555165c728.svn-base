 ...
 *
 */
public class MxNoneThrowingEvent {
	/**
	 * 非抛出事件操作
	 * @param root
	 * @param mxCellList
	...
	public static String noneThrowingEvent(Element root,List mxCellList,Element mxCell){
		String task_node = "";
		/////////////基本属性开始/////////////
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static String noneThrowingEventBpmndi(Element root,List mxCellList,Element mxCell){
		String nodeID = mxCell.attributeValue("nodeID");
