...
Ext.onReady(function(){
	zx_judge_dic = new Ext.data.Store({
		...
		proxy:new Ext.data.HttpProxy({ 
			url:'../xtDataDictionaryController/getXtDataDictionaryByKey?key=zx_judge_again',
	...
	store = getGridJsonStore('../zxJudgeStandardController/getZxJudgeStandardListByCondition?type=2',[]);
...
/**查询操作**/
function search(){
	initSearch(store,'../zxJudgeStandardController/getZxJudgeStandardListByCondition?type=2',searchForm);
}
