...
public class MxEventGateway {
	...
	public static String eventGateway(Element root,List mxCellList,Element mxCell){
		...
		//开区间
        timerStartEvent_node+="<eventBasedGateway id='"+nodeID+"' name='"+name+"' "+asynchronous+isForCompensation+">";
        //****开始区间与闭区间属性 开始****//
        //2备注配置开始
        ...
        //****开始区间与闭区间属性 结束****//
		//闭区间
        timerStartEvent_node += "</eventBasedGateway>";
		//3连线配置开始
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static String eventGatewayBpmndi(Element root,List mxCellList,Element mxCell){
		String nodeID = mxCell.attributeValue("nodeID");
