...
public class SolrIndexAttribute extends BaseEntity implements Serializable{
	...
	private String solr_index_attribute_status;/**状态0启用1禁用**/
	private String solr_index_attribute_issearch;/**是否参与查询0是1否**/
	private String solr_index_id;/**索引编号**/
	private String solr_index_attribute_ctime;/**创建时间**/
	private String solr_index_attribute_mtime;/**修改时间**/
	private String xt_userinfo_id;/**创建者**/
	private String sor_index_highlight;/**是否高亮0是1否**/
	private String sor_index_filter;/**否是作为过滤器查询0是1否**/
	...
	public void setSolr_index_attribute_status(String solr_index_attribute_status){
		this.solr_index_attribute_status=solr_index_attribute_status;
	}
	public String getSolr_index_attribute_status(){
		return solr_index_attribute_status;
	}
	public void setSolr_index_attribute_issearch(String solr_index_attribute_issearch){
		this.solr_index_attribute_issearch=solr_index_attribute_issearch;
	}
	public String getSolr_index_attribute_issearch(){
	...
	public void setSolr_index_attribute_ctime(String solr_index_attribute_ctime){
		this.solr_index_attribute_ctime=solr_index_attribute_ctime;
	}
	public String getSolr_index_attribute_ctime(){
		return solr_index_attribute_ctime;
	}
	public void setSolr_index_attribute_mtime(String solr_index_attribute_mtime){
		this.solr_index_attribute_mtime=solr_index_attribute_mtime;
	}
	public String getSolr_index_attribute_mtime(){
	...
	public String getSor_index_highlight() {
		return sor_index_highlight;
	}
	public void setSor_index_highlight(String sor_index_highlight) {
		this.sor_index_highlight = sor_index_highlight;
	}
	public String getSor_index_filter() {
		return sor_index_filter;
	}
	public void setSor_index_filter(String sor_index_filter) {
