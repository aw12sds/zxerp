...
var materialWin;
function showMaterial(order_id){
	reGetWidthAndHeight();
	materialWin = Ext.create('top.Ext.Window',{
		...
		modal:true,
		title:'物料清单列表',
		html:'<iframe scrolling="auto" frameborder="0" width="100%" height="100%" src="../zxBuyProgressController/loadZxBuyProgressMaterial?order_id='+order_id+'"></iframe>',
		listeners:{
