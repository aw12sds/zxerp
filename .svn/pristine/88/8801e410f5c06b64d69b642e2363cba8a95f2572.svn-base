...
public class MxManualTask {
	...
	public static String manualTask(Element root,List mxCellList,Element mxCell){
		String task_node = "";
		/////////////基本属性开始/////////////
		...
		//开区间
        task_node+="<manualTask id='"+nodeID+"' name='"+name+"' "+MxUtils.normal(mxCell)+">";
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static String manualTaskBpmndi(Element root,List mxCellList,Element mxCell){
		String nodeID = mxCell.attributeValue("nodeID");
