 ...
 *
 */
public class MxSignalThrowingEvent {
	/**
	 * 信号抛出事件节点操作
	 * @param root
	 * @param mxCellList
	...
	public static String signalThrowingEvent(Element root,List mxCellList,Element mxCell){
		String task_node = "";
		/////////////基本属性开始/////////////
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static String signalThrowingEventBpmndi(Element root,List mxCellList,Element mxCell){
		String nodeID = mxCell.attributeValue("nodeID");
