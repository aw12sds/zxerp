...
public class MxTerminateEndEvent {
	...
	public static String terminateEndEvent(Element root,List mxCellList,Element mxCell){
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static String terminateEndEventBpmndi(Element root,List mxCellList,Element mxCell){
		String nodeID = mxCell.attributeValue("nodeID");
