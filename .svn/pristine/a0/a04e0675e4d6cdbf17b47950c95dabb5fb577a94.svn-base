	...
	<head>
		...
		<script type="text/javascript" src="${syspath}/deng/source/plugins/e6/classic/locale/locale-zh_CN.js"></script>
	   	<script type="text/javascript">
	    	...
	    	var sys_pt_departinfo_name = "${xtUserinfo.xt_departinfo_name}";
	    	var sys_pt_post_name = "${xtUserinfo.xt_post_name}";
		...
		<c:if test="${not empty xtUserinfo.xt_userinfo_id}">
			...
			xt_departinfo_id = '${xtUserinfo.xt_departinfo_id}';
			xt_post_id = '${xtUserinfo.xt_post_id}';
			</script>
		</c:if>
        <%
