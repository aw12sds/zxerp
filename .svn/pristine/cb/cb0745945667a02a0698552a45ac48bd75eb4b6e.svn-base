...
public class BRecommend extends XtAttachment implements Serializable{
	...
	private String b_recommend_ctime;/**创建时间**/
	private String b_recommend_mtime;/**修改时间**/
	private String b_recommend_status;/**状态0正常1禁用**/
	...
	public void setB_recommend_ctime(String b_recommend_ctime){
		this.b_recommend_ctime=b_recommend_ctime;
	}
	public String getB_recommend_ctime(){
		return b_recommend_ctime;
	}
	public void setB_recommend_mtime(String b_recommend_mtime){
		this.b_recommend_mtime=b_recommend_mtime;
	}
	public String getB_recommend_mtime(){
		return b_recommend_mtime;
	}
	public void setB_recommend_status(String b_recommend_status){
		this.b_recommend_status=b_recommend_status;
	}
	public String getB_recommend_status(){
