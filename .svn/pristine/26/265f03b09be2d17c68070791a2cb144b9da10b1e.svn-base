...
<title>万年历</title>
<link rel="stylesheet" type="text/css" href="${syspath}/deng/source/plugins/other/jquery/perpetualcalendar/css/style.css">
<script type="text/javascript" src="${syspath}/deng/source/plugins/other/jquery/perpetualcalendar/js/main.js"></script>
</head>
<body onload=initial();>
<div id="content">
<!-- 显示日期详情 -->
