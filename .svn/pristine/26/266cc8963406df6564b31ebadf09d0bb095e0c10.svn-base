 ...
 *
 */
public class MxExclusiveGateway {
	/**
	 * 排他网关操作
	 * @param root
	 * @param mxCellList
	...
	public static String exclusiveGateway(Element root,List mxCellList,Element mxCell){
		String task_node = "";
		/////////////基本属性开始/////////////
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static String exclusiveGatewayBpmndi(Element root,List mxCellList,Element mxCell){
		String nodeID = mxCell.attributeValue("nodeID");
