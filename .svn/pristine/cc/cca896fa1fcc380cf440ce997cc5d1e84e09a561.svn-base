...
public class MxReceiveTask {
	...
	public static String receiveTask(Element root,List mxCellList,Element mxCell){
		String task_node = "";
		/////////////基本属性开始/////////////
		...
		//开区间
        task_node+="<receiveTask id='"+nodeID+"' name='"+name+"' "+MxUtils.normal(mxCell)+">";
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static String receiveTaskBpmndi(Element root,List mxCellList,Element mxCell){
		String nodeID = mxCell.attributeValue("nodeID");
