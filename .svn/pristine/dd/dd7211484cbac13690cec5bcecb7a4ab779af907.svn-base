 ...
 *
 */
public class MxErrorStartEvent {
	/**
	 * 错误启动事件操作
	 * @param mxCellList
	 * @param mxCel
	...
	public static String errorStartEvent(Element root,List mxCellList,Element mxCell){
		...
		/////////////基本属性开始/////////////
 		...
 		/////////////主要配置开始/////////////
 		String signalRef = mxCell.attributeValue("errorRef");
        ...
        timerStartEvent_node += "</extensionElements>";
        //3信号启动事件开始
        timerStartEvent_node += "<errorEventDefinition "+signalRef+"/>";
        //3信号启动事件结束
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static String errorStartEventBpmndi(Element root,List mxCellList,Element mxCell){
		String nodeID = mxCell.attributeValue("nodeID");
