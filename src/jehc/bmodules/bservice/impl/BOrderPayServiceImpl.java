		...
		try {
			...
			if(0<(b_Order_Pay.getB_order_pay_money()) && (b_Order_Pay.getB_order_pay_money()) <price){
				...
				if(null != b_Member_Account_Proprietary && !"".equals(b_Member_Account_Proprietary)){
					...
					b_Member_Account_Proprietary.setB_member_account_proprietary_ctime(CommonUtils.getSimpleDateFormat());
				...
				b_Member_Account_Proprietary_His.setB_member_account_proprietary_his_ctime(CommonUtils.getSimpleDateFormat());
			...
			b_Order.setB_invoice_mtime(CommonUtils.getSimpleDateFormat());
			bOrderService.updateBOrderType(b_Order);
			b_Order_Pay.setB_order_pay_ctime(CommonUtils.getSimpleDateFormat());
