 ...
 *
 */
public class MxMessageCatchingEvent {
	/**
	 * 消息捕捉事件操作
	 * @param root
	 * @param mxCellList
	...
	public static String messageCatchingEvent(Element root,List mxCellList,Element mxCell){
		String task_node = "";
		/////////////基本属性开始/////////////
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static String messageCatchingEventBpmndi(Element root,List mxCellList,Element mxCell){
		String nodeID = mxCell.attributeValue("nodeID");
