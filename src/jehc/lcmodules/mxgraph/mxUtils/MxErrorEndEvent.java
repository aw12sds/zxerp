...
public class MxErrorEndEvent {
	...
	public static String errorEndEvent(Element root,List mxCellList,Element mxCell){
		...
		/////////////基本属性开始/////////////
 		...
 		/////////////主要配置开始/////////////
 		String errorRef = mxCell.attributeValue("errorRef");
		...
		//开区间
        timerStartEvent_node+="<endEvent id='"+nodeID+"' name='"+name+"' "+asynchronous+isForCompensation+">";
        ...
        //****开始区间与闭区间属性 结束****//
        //3错误结束事件开始
        timerStartEvent_node += "<errorEventDefinition "+errorRef+"/>";
        //3错误结束事件结束
		//闭区间
        timerStartEvent_node += "</endEvent>";
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static String errorEndEventBpmndi(Element root,List mxCellList,Element mxCell){
		String nodeID = mxCell.attributeValue("nodeID");
