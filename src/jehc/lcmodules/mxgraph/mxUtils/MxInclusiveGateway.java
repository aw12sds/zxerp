 ...
 *
 */
public class MxInclusiveGateway {
	/**
	 * 包括网关操作
	 * @param mxCellList
	 * @param mxCel
	...
	public static String inclusiveGateway(Element root,List mxCellList,Element mxCell){
		...
		//开区间
        timerStartEvent_node+="<inclusiveGateway id='"+nodeID+"' name='"+name+"' "+asynchronous+isForCompensation+">";
        //****开始区间与闭区间属性 开始****//
        //2备注配置开始
        ...
        //****开始区间与闭区间属性 结束****//
		//闭区间
        timerStartEvent_node += "</inclusiveGateway>";
		//3连线配置开始
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static String inclusiveGatewayBpmndi(Element root,List mxCellList,Element mxCell){
		String nodeID = mxCell.attributeValue("nodeID");
