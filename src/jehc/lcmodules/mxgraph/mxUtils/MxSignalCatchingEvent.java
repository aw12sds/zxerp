 ...
 *
 */
public class MxSignalCatchingEvent {
	/**
	 * 信号捕捉事件操作
	 * @param root
	 * @param mxCellList
	...
	public static String signalCatchingEvent(Element root,List mxCellList,Element mxCell){
		String task_node = "";
		/////////////基本属性开始/////////////
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static String signalCatchingEventBpmndi(Element root,List mxCellList,Element mxCell){
		String nodeID = mxCell.attributeValue("nodeID");
