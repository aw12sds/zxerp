 ...
 *
 */
public class MxCalcelBoundaryEvent {
	/**
	 * 取消边界
	 * @param root
	 * @param mxCellList
	...
	public static String calcelBoundaryEvent(Element root,List mxCellList,Element mxCell){
		//获取父节点开始
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static String calcelBoundaryEventBpmndi(Element root,List mxCellList,Element mxCell){
		String nodeID = mxCell.attributeValue("nodeID");
