...
public class MxCancelEndEvent {
	...
	public static String cancelEndEvent(Element root,List mxCellList,Element mxCell){
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static String cancelEndEventBpmndi(Element root,List mxCellList,Element mxCell){
		String nodeID = mxCell.attributeValue("nodeID");
