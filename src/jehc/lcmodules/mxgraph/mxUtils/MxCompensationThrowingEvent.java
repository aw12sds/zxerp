 ...
 *
 */
public class MxCompensationThrowingEvent {
	/**
	 * 补偿抛出事件操作
	 * @param root
	 * @param mxCellList
	...
	public static String compensationThrowingEvent(Element root,List mxCellList,Element mxCell){
		String task_node = "";
		/////////////基本属性开始/////////////
		...
		//闭区间
		task_node += "</intermediateThrowEvent>";
		//3连线配置开始
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static String compensationThrowingEventBpmndi(Element root,List mxCellList,Element mxCell){
		String nodeID = mxCell.attributeValue("nodeID");
