 ...
 *
 */
public class MxTimerBoundaryEvent {
	/**
	 * 时间边界操作
	 * @param root
	 * @param mxCellList
	...
	public static String timerBoundaryEvent(Element root,List mxCellList,Element mxCell){
		//获取父节点开始
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static String timerBoundaryEventBpmndi(Element root,List mxCellList,Element mxCell){
		String nodeID = mxCell.attributeValue("nodeID");
