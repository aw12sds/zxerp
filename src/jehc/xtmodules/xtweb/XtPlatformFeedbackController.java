...
public class XtPlatformFeedbackController extends BaseAction{
	...
	*/
	...
	public ModelAndView loadXtPlatformFeedback(XtPlatformFeedback xt_Platform_Feedback,HttpServletRequest request){
	...
	*/
	...
	public String getXtPlatformFeedbackListByCondition(BaseSearch baseSearch,HttpServletRequest request){
		...
		List<XtPlatformFeedback> xt_Platform_FeedbackList = xtPlatformFeedbackService.getXtPlatformFeedbackListByCondition(condition);
		PageInfo<XtPlatformFeedback> page = new PageInfo<XtPlatformFeedback>(xt_Platform_FeedbackList);
	...
	*/
	...
	public String getXtPlatformFeedbackById(String xt_platform_feedback_id,HttpServletRequest request){
		XtPlatformFeedback xt_Platform_Feedback = xtPlatformFeedbackService.getXtPlatformFeedbackById(xt_platform_feedback_id);
	...
	*/
	...
	public String addXtPlatformFeedback(XtPlatformFeedback xt_Platform_Feedback,HttpServletRequest request){
		int i = 0;
		if(null != xt_Platform_Feedback && !"".equals(xt_Platform_Feedback)){
			xt_Platform_Feedback.setXt_platform_feedback_id(UUID.toUUID());
			i=xtPlatformFeedbackService.addXtPlatformFeedback(xt_Platform_Feedback);
		}
		if(i>0){
	...
	*/
	...
	public String updateXtPlatformFeedback(XtPlatformFeedback xt_Platform_Feedback,HttpServletRequest request){
		int i = 0;
		if(null != xt_Platform_Feedback && !"".equals(xt_Platform_Feedback)){
			i=xtPlatformFeedbackService.updateXtPlatformFeedback(xt_Platform_Feedback);
		}
		if(i>0){
			return outAudStr(true);
		}else{
