...
function selectMaterial(numbers){
	initMaterialTreeGrid(numbers);
...
function initMaterialTreeGrid(numbers){
	materialWinStore = Ext.create('top.Ext.data.TreeStore',{
        ...
        proxy:{
            type:'ajax',
            method:'post',
			url:'../zxOfficeController/getOfficeTree',
			reader:{
				type:'json'
			},
			extraParams:{
        ...
        listeners:{ 
            ...
            'rowdblclick':function(grid, rowIndex, e){
				...
				if(type == '用品'){
					...
					Ext.getCmp('zxGoodsApplyDetail['+numbers+']').getComponent('zxGoodsApplyDetail['+numbers+'].items').getComponent('zxGoodsApplyDetail['+numbers+'].office_name').setValue(text);
					Ext.getCmp('zxGoodsApplyDetail['+numbers+']').getComponent('zxGoodsApplyDetail['+numbers+'].items').getComponent('zxGoodsApplyDetail['+numbers+'].goods_id').setValue(id);
							materialWin.close();
				}
			}
        },
