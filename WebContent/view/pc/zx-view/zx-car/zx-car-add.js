...
function addZxCar(){
	initZxCarFormAdd();
	zxCarWinAdd = Ext.create('Ext.Window',{
		layout:'fit',
		width:800,
		height:400,
		maximizable:true,
		...
		buttons:[{
			...
			handler:function(button){
				submitForm(zxCarFormAdd,'../zxCarController/addZxCar',grid,zxCarWinAdd,false,true);
			}
		},{
			text:'关闭',
			itemId:'close',
...
function initZxCarFormAdd(){
	zxCarFormAdd = Ext.create('Ext.FormPanel',{
		xtype:'form',
		waitMsgTarget:true,
