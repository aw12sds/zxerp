var zxSixSContentWinEdit;
var zxSixSContentFormEdit;
function updateZxSixSContent(id){
	initZxSixSContentFormEdit();
	zxSixSContentWinEdit = Ext.create('Ext.Window',{
		...
		buttons:[{
			...
			handler:function(button){
				submitForm(zxSixSContentFormEdit,'../zxSixSContentController/updateZxSixSContent',contentGrid,zxSixSContentWinEdit,false,true);
			}
		},{
			text:'关闭',
			itemId:'close',
...
function initZxSixSContentFormEdit(){
	initUpdateFieldItems();
