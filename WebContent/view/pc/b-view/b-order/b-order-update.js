...
function updateBOrder(){
	...
	initBOrderFormEdit(record.items[0].data.b_order_id);
    ...
    reGetWidthAndHeight();
	bOrderWinEdit = Ext.create('top.Ext.Window',{
		layout:'fit',
		width:clientWidth,                    
		height:clientHeight,
//		maximized:true,
		...
		buttons:[{
			...
			handler:function(button){
				...
				submitFormIncludeParams(bOrderFormEdit,'../bOrderController/updateBOrder',grid,bOrderWinEdit,false,true,params);
			}
		},{
			text:'关闭',
			itemId:'close',
	...
	bOrderWinEdit.show();
	loadFormData(bOrderFormEdit,'../bOrderController/getBOrderById?b_order_id='+ record.items[0].data.b_order_id);
	top.Ext.getCmp('summoney').setText("汇总金额:"+record.items[0].data.b_order_total_price+"元/单位");
}
function initBOrderFormEdit(b_order_id){
	...
	bOrderFormEdit = Ext.create('top.Ext.FormPanel',{
		xtype:'form',
		waitMsgTarget:true,
