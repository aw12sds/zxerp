var bInvoiceWinEdit;
var bInvoiceFormEdit;
function updateBInvoice(){
	var record = grid.getSelectionModel().selected;
	if(record.length == 0){
		msgTishi('请选择要修改的一项！');
		return;
	}
	initBInvoiceFormEdit();
	...
	bInvoiceWinEdit = Ext.create('Ext.Window',{
		layout:'fit',
		width:800,
		height:400,
		maximized:true,
		...
		items:bInvoiceFormEdit,
		buttons:[{
			text:'保存',
			itemId:'save',
			handler:function(button){
				submitForm(bInvoiceFormEdit,'../bInvoiceController/updateBInvoice',grid,bInvoiceWinEdit,false,true);
			}
		},{
			text:'关闭',
			itemId:'close',
	...
	bInvoiceWinEdit.show();
	loadFormData(bInvoiceFormEdit,'../bInvoiceController/getBInvoiceById?b_invoice_id='+ record.items[0].data.b_invoice_id);
}
function initBInvoiceFormEdit(){
	bInvoiceFormEdit = Ext.create('Ext.FormPanel',{
		xtype:'form',
		waitMsgTarget:true,
