...
Ext.onReady(function(){
	...
	store = getGridJsonStore('../xtMessageController/getXtMessageSendListByCondition',[]);
...
/**查询操作**/
function search(){
	initSearch(store,'../xtMessageController/getXtMessageSendListByCondition',searchForm); 
}
function update(){
