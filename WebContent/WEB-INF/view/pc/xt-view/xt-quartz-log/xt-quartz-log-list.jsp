...
<title>任务调度日志</title>  
	...
	<script type="text/javascript" src="../view/pc/xt-view/xt-quartz-log/xt-quartz-log-add.js"></script> 
	<script type="text/javascript" src="../view/pc/xt-view/xt-quartz-log/xt-quartz-log-update.js"></script> 
