...
<title>用户角色权限</title>  
	...
	<script type="text/javascript" src="../view/pc/xt-view/xt-roleinfo/xt-roleinfo-list-deleted.js"></script>  
	<script type="text/javascript" src="../view/pc/xt-view/xt-roleinfo/xt-roleinfo-add.js"></script>  
	<script type="text/javascript" src="../view/pc/xt-view/xt-roleinfo/xt-roleinfo-update.js"></script> 
