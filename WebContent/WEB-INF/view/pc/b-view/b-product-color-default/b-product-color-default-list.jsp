...
<meta charset="UTF-8">  
<title>商品默认颜色</title>  
	<script type="text/javascript" src="../view/pc/b-view/b-product-color-default/b-product-color-default-list.js"></script> 
	<script type="text/javascript" src="../view/pc/b-view/b-product-color-default/b-product-color-default-add.js"></script> 
	<script type="text/javascript" src="../view/pc/b-view/b-product-color-default/b-product-color-default-update.js"></script> 
