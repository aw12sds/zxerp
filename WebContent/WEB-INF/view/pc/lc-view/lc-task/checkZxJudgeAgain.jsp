...
<head>  
<meta charset="UTF-8">  
<title>流程任务-验厂申请审批</title>  
<script type="text/javascript" src="../view/pc/lc-view/lc-task/checkZxJudgeAgain.js"></script> 
<style>
.inline_checkbox{
...
<body>  
	...
	<input type="hidden" value="${taskData.businessKey }" id= "resultId">
